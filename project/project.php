...
<head>
    ...
    <title>Agung Mardika - Project </title>
...
<body class="bg-[#202020]">
    <div class="sticky top-0 bg-[#202020]">
        ...
        <div class="flex justify-center">
            <h2 class="text-4xl text-white font-semibold">Project</h2>
        </div>
        <hr class="my-5 border-2 ">
    </div>
    <div class="container my-12 mx-auto px-4 md:px-12">
        <div class="p-5 mx-auto sm:p-10 md:p-16 border-2 text-gray-800 rounded-lg">
            <div class="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
                <img src="../images/project/aestria/aestria-1.png" alt="aestria-1" class="w-full h-60 sm:h-96 bg-gray-500">
            ...
            <div class="flex flex-col max-w-3xl mx-auto overflow-hidden rounded mt-16">
                <img src="../images/project/ppdb/ppdb-1.png" alt="ppdb" class="w-full h-60 sm:h-96 bg-gray-500">
                <div class="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 rounded-md bg-gray-50">
                    <div class="space-y-2">
